                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        ?>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="../listTask.php?list_id=<?php echo $list_id_nav; ?>"><?php echo $list_name; ?></a>
                                </li>
        ...
        <div class="form">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <label style="width: 15vw">
                        <input type="text" name="task_description" class="form-control" value="<?php echo $task_description ?>" placeholder="Enter task name">
                    </label>
                </div>
                <div class="form-group">
                    <p>Select List:</p>
